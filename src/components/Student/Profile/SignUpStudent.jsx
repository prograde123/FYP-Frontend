    ...
    return (
        ...
        <Box sx={{ width: '80%' }}>
            <Box sx={{ marginLeft: 10, marginRight: 10, marginTop: 4 }}>
                <Typography variant='h5' sx={{ fontWeight: 'bold', marginBottom: 3 }}>Create Account (Student) </Typography>
                ...
                <Box component="form" sx={{ display: 'flex', flexDirection: 'column', width: '100%', marginTop: 1 }}>
                    ...
                    <FormControl sx={{ width: '100%', marginTop: 4 }}  >
                        <InputLabel htmlFor="outlined-adornment-email" color='secondary'>Username</InputLabel>
                        <OutlinedInput
