...
export default function Students() {
    ...
    return (
        ...
        >
            <p style={{ fontWeight: 'bold', marginBottom: 8, fontSize:25, marginLeft:9,marginTop:0, display:'flex', flexDirection:'row', justifyContent:'center' }}><span className='underline'>Lecture Notes</span></p>
