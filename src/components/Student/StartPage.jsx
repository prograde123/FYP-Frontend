         ...
         >
            <Box sx = {{ padding:'3%'}}> <Typography variant='h3' sx={{ fontWeight: 'bold', marginBottom: 3  }}>
               ...
               ProGrade provides grading code-based assignments by providing an automated grading system. The application
                ...
                <GroupsIcon  style={{ color: newtheme.palette.secondary.background , marginRight:'1%' }}/>
                <Typography variant= 'h6' >
                  Over 2k Students
                </Typography>
                <LibraryBooksIcon style={{ marginLeft:'7%',color: newtheme.palette.secondary.background, marginRight:'1%' }}/>
                <Typography variant= 'h6' >
            ...
            <Box ref={boxRef3} sx={{ opacity: isVisible3 ? 1 : 0,
              transform: isVisible3 ? 'translateX(0)' : 'translateX(100%)',
              transition: 'opacity 0.3s ease-in-out, transform 0.3s ease-in-out',}}>  <img src={startImage} height={'90%'} style={{  marginLeft:'4%' }} /> 
            </Box>
         </Box>
         <Box sx={{
         ...
         <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', marginTop:'1%'}}>
          ...
          >
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', width: '20%',alignItems:'center' }}>
              ...
              <Link  href='#' sx={{textDecoration:'none',marginTop:'6%'
          ...
          <Box sx={{display: 'flex', flexDirection: 'column',marginTop:'10%',marginLeft:'42%'}}>
          <Button 
                variant="contained" 
                sx={{ backgroundColor: newtheme.palette.secondary.background,
                '&:hover': {
                  backgroundColor:newtheme.palette.secondary.footer },
                  width: '30%', padding: 2, fontSize: 16, fontWeight: 'bold' }} >
                  View All Courses
          </Button>
          </Box>
          <Box sx={{
                //Khansa's Part
                padding:'5%',marginLeft:'30%', animation: `${animation} 1s ease-in-out 3`,}}>
                <Typography variant="h3" sx={{fontWeight:'bold', 
            }}>Popular Courses</Typography>
          </Box>
          <Box ref={boxRef}
             sx = {{
          ...
          <Box 
            ...
            <Typography sx={{ textAlign:"center" ,padding:'3%',marginTop:'2%'
            }} >
            ...
            <Typography sx={{ padding:'3%',marginTop:'2%'
            }}>
            Dictum varius duis at consectetur lorem donec massa sapien faucibus morbi tempus.
            </Typography>
            </Box>
